...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"ac-library/atcoder/internal_queue.hpp\"\n\n\n\n#include\
    \ <vector>\n\nnamespace atcoder {\n\nnamespace internal {\n\ntemplate <class T>\
  ...
  verifiedWith: []
documentation_of: ac-library/atcoder/internal_queue.hpp
layout: document
redirect_from:
- /library/ac-library/atcoder/internal_queue.hpp
- /library/ac-library/atcoder/internal_queue.hpp.html
