...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"ac-library/atcoder/internal_csr.hpp\"\n\n\n\n#include <algorithm>\n\
    #include <utility>\n#include <vector>\n\nnamespace atcoder {\nnamespace internal\
  ...
  verifiedWith: []
documentation_of: ac-library/atcoder/internal_csr.hpp
layout: document
redirect_from:
- /library/ac-library/atcoder/internal_csr.hpp
- /library/ac-library/atcoder/internal_csr.hpp.html
