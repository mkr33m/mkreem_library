...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"ac-library/atcoder/segtree.hpp\"\n\n\n\n#include <algorithm>\n\
    ...
    \ int n) {\n    int x = 0;\n    while (!(n & (1 << x))) x++;\n    return x;\n\
    }\n\n}  // namespace internal\n\n}  // namespace atcoder\n\n\n#line 6 \"ac-library/atcoder/segtree.hpp\"\
  ...
  verifiedWith: []
documentation_of: ac-library/atcoder/segtree.hpp
layout: document
redirect_from:
- /library/ac-library/atcoder/segtree.hpp
- /library/ac-library/atcoder/segtree.hpp.html
